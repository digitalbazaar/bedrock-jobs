...
function _runWorker(options, callback) {
  ...
  async.until(() => done, loopCallback => {
    ...
    async.auto({
      ...
      getExpiredJob: ['getIdleJob', (callback, results) => {
      ...
      markJob: ['getExpiredJob', (callback, results) => {
      ...
      runJob: ['markJob', (callback, results) => {
      ...
      checkResult: ['runJob', (callback, results) => {
        const record = results.getIdleJob || results.getExpiredJob;
        const job = record.job;
      ...
      cleanup: ['checkResult', (callback, results) => {
